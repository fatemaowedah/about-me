...
while (!(myGender1 == "yes" || myGender1 == "y" || myGender1 == "n" || myGender1 == "no"))
{
    alert('Choose yes or no' );
    myGender = prompt ("Do you think i'm a girl ?");
    myGender1 = myGender.toLowerCase();
...
var myName = prompt ("Do you think Fatima is my name ?");
 ...
 while (!(myName == "yes" || myName == "y" || myName == "n" || myName == "no"))
{
    alert('Choose yes or no' );
...
var myAge = prompt ("Do you think  my age is 24?");
 ...
 while (!(myAge == "yes" || myAge == "y" || myAge == "n" || myAge == "no"))
 {
    alert('Choose yes or no' );
...
while (!(myFavDrin == "yes" || myFavDrin == "y" || myFavDrin == "n" || myFavDrin == "no"))
 {
    alert('Choose yes or no' );
